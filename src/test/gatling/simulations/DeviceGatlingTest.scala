...
class DeviceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Device entity")
        ...
        .repeat(2) {
            ...
            .post("/api/devices")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "manufacture":"SAMPLE_TEXT", "model":"SAMPLE_TEXT", "apiUserId":"SAMPLE_TEXT", "apiUriPrefix":"SAMPLE_TEXT", "apiToken":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
