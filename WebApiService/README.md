...
The WebApiService is responsible for providing the Device and Participent management, as well as help to facilitate the Device lending process.
...
To optimize the labrat application for production, run:
