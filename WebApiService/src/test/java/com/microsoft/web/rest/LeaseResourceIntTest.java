...
import static com.microsoft.web.rest.TestUtil.sameInstant;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.microsoft.domain.enumeration.LeaseStatus;
/**
...
public class LeaseResourceIntTest {
    ...
    public void createLeaseWithExistingId() throws Exception {
        ...
        LeaseDTO existingLeaseDTO = leaseMapper.leaseToLeaseDTO(existingLease);

        // An entity with an existing ID cannot be created, so this API call must fail
        restLeaseMockMvc.perform(post("/api/leases")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingLeaseDTO)))
